...
show.cacomp <- function(object) {
    ...
    cat(
        "\nCalc. standard coord.: ",
        paste0(
            "std_coords_rows"[!is.empty(object@std_coords_rows)],
    ...
    cat(
        ...
        paste0(
            "prin_coords_rows"[!is.empty(object@prin_coords_rows)],
    ...
    cat(
        "\nCalc. APL coord.:      ",
        paste0(
            "apl_rows"[!is.empty(object@apl_rows)],
