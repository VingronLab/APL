...
If necessary, the environment can also be accessed through reticulate:

```{r reticulate_conda, eval=FALSE}
library(reticulate)
use_condaenv(condaenv = file.path(miniconda_path(),"envs/APL-env"),
             required=TRUE)
```

Instead of installing `pytorch`, users can also opt to use the R native SVD/irlba.
