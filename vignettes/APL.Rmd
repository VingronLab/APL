...
By default SVD with pytorch is turned off to ensure it runs everywhere. Users who installed `pytorch`, can turn the argument `python = TRUE` wherever applicable in this vignette to speed up the calculations.
