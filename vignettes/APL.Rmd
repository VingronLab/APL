...
Once the coordinates for the Association Plot are calculate, they will also be shown in the output of `cacomp`. Slots are accessed through an ccessor  function:
```{r std_coords}
